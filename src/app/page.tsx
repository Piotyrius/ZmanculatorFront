        ...
        <section className="flex flex-col items-start gap-8 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-5">
            ...
            <h1 className="text-3xl font-semibold leading-tight md:text-4xl lg:text-5xl">
              Powerful pattern construction for modern garment workflows
            </h1>
            <p className="max-w-xl text-sm text-slate-300 md:text-base">
              Manage measurement profiles, projects, and pattern exports in one workspace
              designed for pattern makers and technical designers.
            </p>
                ...
                <div className="space-y-3 text-[11px] text-slate-300">
                  ...
                  <div className="rounded-lg border border-slate-800 bg-slate-900/80 px-2 py-2">
                    ...
                    <p className="mt-1 text-[11px]">
                      Capture measurements, configure drafting schools and blocks, and
                      export production‑ready patterns.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <ol className="grid gap-3 text-sm text-slate-300 md:grid-cols-4">
            <li className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
              ...
              <p className="mt-2 text-sm">
                Capture and organize detailed measurement profiles.
              </p>
            </li>
            <li className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
              <span className="text-xs font-semibold text-sky-300">2</span>
              <p className="mt-2 text-sm">
                Create projects and connect drafting schools, blocks, and rule
                graphs.
              </p>
            </li>
            <li className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
              ...
              <p className="mt-2 text-sm">
                Generate patterns using your preferred grading and ease
                profiles.
              </p>
            </li>
            <li className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
              ...
              <p className="mt-2 text-sm">
                Export SVG, DXF, or PDF files for downstream CAD and
                manufacturing.
              </p>
            </li>
          </ol>
